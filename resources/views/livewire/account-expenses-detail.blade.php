        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="expense.assign_id"
                            label="Assign"
                            wire:model="expense.assign_id"
                        >
                            <option value="null" disabled>Please select the Assign</option>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.account_expenses.inputs.date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.account_expenses.inputs.date_to')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.account_expenses.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.account_expenses.inputs.cluster_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.account_expenses.inputs.assign_id')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.account_expenses.inputs.budget')
                    </th>
                    <th></th>
                </tr>
            </thead>
