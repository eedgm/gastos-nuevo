        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="executed.type_id"
                            label="Type"
                            wire:model="executed.type_id"
                        >
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-right">
                        @lang('crud.expense_executeds.inputs.cost')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.expense_executeds.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.expense_executeds.inputs.type_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
