            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.cluster_expenses.inputs.date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.cluster_expenses.inputs.date_to')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.cluster_expenses.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.cluster_expenses.inputs.assign_id')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.cluster_expenses.inputs.budget')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.cluster_expenses.inputs.account_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
