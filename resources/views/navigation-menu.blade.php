        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('assigns.index') }}">
                        Assigns
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Color::class)
                        <x-dropdown-link href="{{ route('colors.index') }}">
                        Colors
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Executed::class)
                        <x-dropdown-link href="{{ route('executeds.index') }}">
                        Executeds
                        </x-dropdown-link>
                        @endcan
                        ...
                        <x-dropdown-link href="{{ route('purposes.index') }}">
                        Purposes
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Assign::class)
                <x-jet-responsive-nav-link href="{{ route('assigns.index') }}">
                Assigns
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Bank::class)
                ...
                @endcan
                @can('view-any', App\Models\Cluster::class)
                <x-jet-responsive-nav-link href="{{ route('clusters.index') }}">
                Clusters
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Color::class)
                <x-jet-responsive-nav-link href="{{ route('colors.index') }}">
                Colors
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Executed::class)
                <x-jet-responsive-nav-link href="{{ route('executeds.index') }}">
                Executeds
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Expense::class)
                ...
                @endcan
                @can('view-any', App\Models\Income::class)
                <x-jet-responsive-nav-link href="{{ route('incomes.index') }}">
                Incomes
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Purpose::class)
                <x-jet-responsive-nav-link href="{{ route('purposes.index') }}">
                Purposes
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Type::class)
                <x-jet-responsive-nav-link href="{{ route('types.index') }}">
                Types
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
